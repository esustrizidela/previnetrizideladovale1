...
('cidadao_01', '000', 'Cidadão', 'user-check', 'N', '.content-body', NULL, '#', NULL, 1, 'cidadao', 0, NULL, NULL, 'bg-primary', NULL, NULL, NULL),
('cidadao_02', 'cidadao_01', 'Dados/Cartão', 'user-check', 'C', '.content-body', 'mod/cidadao/cidadao.php', '#', NULL, 1, 'cidadao', 0, NULL, NULL, 'bg-primary', NULL, NULL, NULL),
('cidadao_03', 'cidadao_01', 'Duplicados', 'users', 'C', '.content-body', 'mod/cidadao/duplicados.php', '#', NULL, 1, 'cidadao', 0, NULL, NULL, 'bg-primary', NULL, NULL, NULL),
...
('cidadao_06', 'cidadao_04', 'Cadastros (por eq.)', 'archive', 'C', '.content-body', 'mod/cidadao/frm_tb_my.php?ap=cidadao_tb_sisab_cadastros&nb=Cadastros', '#', NULL, 1, 'cidadao', 0, NULL, NULL, 'bg-primary', NULL, NULL, NULL),
('cidadao_07', 'cidadao_04', 'Denominador (Apoio ao Cuid.)', 'archive', 'C', '.content-body', 'mod/cidadao/frm_tb_my.php?ap=cidadao_tb_sisab_denominador&nb=Denominador', '#', NULL, 1, 'cidadao', 0, NULL, NULL, 'bg-primary', NULL, NULL, NULL),
...
('cidadao_13', 'cidadao_04', 'Compara', 'link', 'C', '.content-body', 'mod/cidadao/frm_compara.php', '#', NULL, 1, 'cidadao', 0, NULL, NULL, 'bg-primary', NULL, NULL, NULL),
...
INSERT INTO `sc_tb_modulos` (`modulo`) VALUES ('cidadao');

CREATE TABLE IF NOT EXISTS `cidadao_tb_cf_geral` (
